...
- `barbeque-grilled-chicken-rice-bowl`: name: "Barbeque Grilled Chicken Rice Bowl" → "Chicken Burrito Bowl — choose your sauce" · pricePaise: 24900 → 29900 · sectionOrder: null → 2 · sortRank: null → 1 · vegClass: null → "non-veg" · customizations: [] → [{"groupName":"Choose your sauce","type":"single","required":true,"options":[{"name":"Cilantro Lime","priceModifier":0,"default":true},{"name":"Tandoori","priceModifier":0},{"name":"Chipotle","priceModifier":0},{"name":"BBQ","priceModifier":0},{"name":"Peri Peri","priceModifier":0}]}]
- `chilli-chipotle-paneer-rice-bowl`: name: "Chilli Chipotle Paneer Rice Bowl" → "Paneer Burrito Bowl — choose your sauce" · pricePaise: 19900 → 24900 · sectionOrder: null → 2 · sortRank: null → 2 · vegClass: null → "veg" · customizations: [] → [{"groupName":"Choose your sauce","type":"single","required":true,"options":[{"name":"Cilantro Lime","priceModifier":0,"default":true},{"name":"Tandoori","priceModifier":0},{"name":"Chipotle","priceModifier":0},{"name":"BBQ","priceModifier":0},{"name":"Peri Peri","priceModifier":0}]}]
- `crispy-mushroom-rice-bowl`: name: "Crispy Mushroom Rice Bowl" → "Mushroom Burrito Bowl — choose your sauce" · pricePaise: 22900 → 19900 · sectionOrder: null → 2 · sortRank: null → 3 · vegClass: null → "veg" · customizations: [] → [{"groupName":"Choose your sauce","type":"single","required":true,"options":[{"name":"Cilantro Lime","priceModifier":0,"default":true},{"name":"Tandoori","priceModifier":0},{"name":"Chipotle","priceModifier":0},{"name":"BBQ","priceModifier":0},{"name":"Peri Peri","priceModifier":0}]}]
- `quinoa-khichdi`: pricePaise: 9900 → 17900 · sectionOrder: null → 2 · sortRank: null → 4 · vegClass: null → "veg"
- `barbeque-chicken-burrito-wrap`: name: "Barbeque Chicken Burrito Wrap" → "BBQ Chicken Tikka Wrap" · pricePaise: 22900 → 19900 · sectionOrder: null → 3 · sortRank: null → 1 · vegClass: null → "non-veg" · badge: null → "Trending" · customizations: [] → [{"groupName":"Choose your sauce","type":"single","required":true,"options":[{"name":"Cilantro Lime","priceModifier":0,"default":true},{"name":"Tandoori","priceModifier":0},{"name":"Chipotle","priceModifier":0},{"name":"BBQ","priceModifier":0},{"name":"Peri Peri","priceModifier":0}]},{"groupName":"Make it a burrito","type":"single","options":[{"name":"Burrito upgrade","priceModifier":2000}]}]
- `healthy-whole-wheat-chicken-tikka-wrap`: name: "Healthy Whole Wheat Chicken Tikka Wrap" → "Chicken Tikka Wrap (Whole Wheat)" · pricePaise: 21900 → 19900 · sectionOrder: null → 3 · sortRank: null → 2 · vegClass: null → "non-veg" · customizations: [] → [{"groupName":"Choose your sauce","type":"single","required":true,"options":[{"name":"Cilantro Lime","priceModifier":0,"default":true},{"name":"Tandoori","priceModifier":0},{"name":"Chipotle","priceModifier":0},{"name":"BBQ","priceModifier":0},{"name":"Peri Peri","priceModifier":0}]},{"groupName":"Make it a burrito","type":"single","options":[{"name":"Burrito upgrade","priceModifier":2000}]}]
- `paneer-tikka-burrito-wrap`: name: "Paneer Tikka Burrito Wrap" → "Paneer Tikka Wrap" · pricePaise: 19900 → 17900 · sectionOrder: null → 3 · sortRank: null → 3 · vegClass: null → "veg" · customizations: [] → [{"groupName":"Choose your sauce","type":"single","required":true,"options":[{"name":"Cilantro Lime","priceModifier":0,"default":true},{"name":"Tandoori","priceModifier":0},{"name":"Chipotle","priceModifier":0},{"name":"BBQ","priceModifier":0},{"name":"Peri Peri","priceModifier":0}]},{"groupName":"Make it a burrito","type":"single","options":[{"name":"Burrito upgrade","priceModifier":2000}]}]
...
- `high-protein-chicken-omelette`: name: "High Protein Chicken Omelette" → "High Protein Chicken Omelette (2 eggs)" · pricePaise: 16900 → 14900 · sectionOrder: null → 6 · sortRank: null → 5 · vegClass: null → "non-veg" · customizations: [] → [{"groupName":"Omelette add-ons","type":"multiple","options":[{"name":"Mushroom","priceModifier":3000},{"name":"Spinach","priceModifier":3000},{"name":"Tomato & Cheese","priceModifier":3000}]}]
...
- `veg-loaded-bread-omelette-2-egg`: name: "Veg Loaded Bread Omelette (2 Egg)" → "Veg Loaded Omelette (2 eggs)" · sectionOrder: null → 6 · sortRank: null → 12 · vegClass: null → "egg" · customizations: [] → [{"groupName":"Omelette add-ons","type":"multiple","options":[{"name":"Mushroom","priceModifier":3000},{"name":"Spinach","priceModifier":3000},{"name":"Tomato & Cheese","priceModifier":3000}]}]
- `classic-bread-omelette-2-egg`: name: "Classic Bread Omelette (2 Egg)" → "Bread Omelette — Classic / Masala" · pricePaise: 8900 → 12900 · sectionOrder: null → 6 · sortRank: null → 15 · vegClass: null → "egg" · customizations: [] → [{"groupName":"Style","type":"single","required":true,"options":[{"name":"Classic","priceModifier":0,"default":true},{"name":"Masala","priceModifier":0}]}]
- `plain-omelette`: name: "Plain Omelette" → "Plain Omelette (2 eggs)" · pricePaise: 11900 → 9900 · sectionOrder: null → 6 · sortRank: null → 16 · vegClass: null → "egg" · customizations: [] → [{"groupName":"Omelette add-ons","type":"multiple","options":[{"name":"Mushroom","priceModifier":3000},{"name":"Spinach","priceModifier":3000},{"name":"Tomato & Cheese","priceModifier":3000}]}]
...
- `aglio-olio-pasta-v`: pricePaise: 24000 → 19900 · sectionOrder: null → 8 · sortRank: null → 1 · vegClass: null → "veg" · customizations: [] → [{"groupName":"Pasta base","type":"single","required":true,"options":[{"name":"Penne","priceModifier":0,"default":true},{"name":"Spaghetti","priceModifier":0}]},{"groupName":"Add protein","type":"single","options":[{"name":"Chicken","priceModifier":4000}]}]
- `arrabbiata-veg`: name: "Arrabbiata - Veg" → "Arrabbiata Pasta" · pricePaise: 17900 → 19900 · sectionOrder: null → 8 · sortRank: null → 2 · vegClass: null → "veg" · customizations: [] → [{"groupName":"Pasta base","type":"single","required":true,"options":[{"name":"Penne","priceModifier":0,"default":true},{"name":"Spaghetti","priceModifier":0}]},{"groupName":"Add protein","type":"single","options":[{"name":"Chicken","priceModifier":4000}]}]
- `alfredo-pasta-veg`: name: "Alfredo Pasta - Veg" → "Alfredo Pasta" · pricePaise: 22900 → 19900 · sectionOrder: null → 8 · sortRank: null → 3 · vegClass: null → "veg" · customizations: [] → [{"groupName":"Pasta base","type":"single","required":true,"options":[{"name":"Penne","priceModifier":0,"default":true},{"name":"Spaghetti","priceModifier":0}]},{"groupName":"Add protein","type":"single","options":[{"name":"Chicken","priceModifier":4000}]}]
- `pesto-pasta-veg`: name: "Pesto Pasta (Veg)" → "Pesto Pasta" · pricePaise: 22900 → 19900 · sectionOrder: null → 8 · sortRank: null → 4 · vegClass: null → "veg" · customizations: [] → [{"groupName":"Pasta base","type":"single","required":true,"options":[{"name":"Penne","priceModifier":0,"default":true},{"name":"Spaghetti","priceModifier":0}]},{"groupName":"Add protein","type":"single","options":[{"name":"Chicken","priceModifier":4000}]}]
...
- `hot-n-sour-soup-veg`: name: "Hot n Sour Soup (Veg)" → "Hot & Sour Soup" · pricePaise: 13900 → 7900 · sectionOrder: null → 9 · sortRank: null → 3 · vegClass: null → "veg" · customizations: [] → [{"groupName":"Make it chicken","type":"single","options":[{"name":"Chicken","priceModifier":4000}]}]
- `manchow-soup-veg`: name: "Manchow Soup (Veg)" → "Manchow Soup" · pricePaise: 13900 → 7900 · sectionOrder: null → 9 · sortRank: null → 4 · vegClass: null → "veg" · customizations: [] → [{"groupName":"Make it chicken","type":"single","options":[{"name":"Chicken","priceModifier":4000}]}]
