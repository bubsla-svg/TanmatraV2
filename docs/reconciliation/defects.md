...
GROUPORDER-001 (Phase 4.4, this PR) (MAJOR). MARKETPLACE-001 (Phase 4.3) is
resolved on its own not-yet-merged PR, so still shows Open here. Machine-
readable form: `defects.json`. IDs
