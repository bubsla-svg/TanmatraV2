...
/**
 * The LIGHT-arm action gold (`--color-accent` light stop). This is the value
 * for third-party LIGHT UIs: Razorpay's modal is a light sheet that sets
 * white text over `theme.color`, the exact pairing our own light arm uses
 * (`--color-accent-ink` light = #ffffff). The dark-arm gold #D4AF37 measures
 * ~2:1 under white text — never hand it to a surface that renders white on
 * top of it.
 */
export const ACCENT_GOLD_LIGHT = "#7F6921";
