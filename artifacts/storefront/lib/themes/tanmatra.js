...
/**
 * tanmatra theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { tanmatraTheme } from './tanmatra';
 *   import './tanmatra.css';
 */
export const tanmatraTheme = {
  name: 'tanmatra',
  __built: true,
  tokens: {
    ...
    "--color-background-surface": "light-dark(#ffffff, #17191c)",
    ...
    "--color-accent": "light-dark(#7F6921, #D4AF37)",
    ...
    "--color-text-primary": "light-dark(#1a1c1e, #e9ecee)",
    "--color-text-secondary": "light-dark(#5c6367, #8b9398)",
    ...
    "--color-success": "light-dark(#3D5C3E, #7D9E7E)",
    "--color-error": "light-dark(#a50c25, #ffc6c1)",
    "--color-warning": "light-dark(#7A5E12, #D8B45E)",
    ...
    "--color-border": "light-dark(#e7e3da, #262a2e)",
    ...
    "--color-accent-ink": "light-dark(#ffffff, #111318)",
    "--color-blue": "light-dark(#2D6A8F, #6BA3C8)",
    "--color-sage": "light-dark(#3D5C3E, #7D9E7E)",
    "--color-danger": "light-dark(#8C3214, #C2603F)",
    "--color-background-app": "light-dark(#fbfaf7, #0e0f11)",
    "--color-background-raised": "light-dark(#ffffff, #1e2125)",
    "--color-text-tertiary": "light-dark(#6b7378, #7f878c)",
    "--color-border-strong": "light-dark(#d8d3c7, #333940)",
    "--radius-sm": "6px",
    "--radius-md": "10px",
    "--radius-lg": "16px",
    "--radius-xl": "22px",
