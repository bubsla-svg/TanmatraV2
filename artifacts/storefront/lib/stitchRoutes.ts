...
export const STITCH_EXACT_ROUTES: readonly string[] = [
  ...
  // ── 2026-08-13 seam-ledger tranche (docs/DESIGN-SYSTEM-RECONCILIATION.md
  //    seam #1): the four routes a 390px audit measured LIGHT while the five
  //    core surfaces were dark — one session, Menu → Care flipped black→white
  //    and welded the (hardcoded-dark) bottom nav onto a white page. Dark is
  //    the brand canvas; these join it. Every colour on them is a light-dark()
  //    token (lint:dark-forks holds at 0), so this is allowlist work.
  "/care", // Clinical hub — linked from the dark home/menu chrome.
...
export const STITCH_PREFIX_ROUTES: readonly string[] = [
  ...
  // 2026-08-13 tranche — the exact routes above bring their families:
  "/care/", // /care/[condition].
