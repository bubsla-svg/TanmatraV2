"use client";
// Client island: the gym ancillary-revenue ESTIMATOR. This is a marketing
// illustration, NOT a quote — nothing here is charged, so the arithmetic is
// deliberately client-side (the money-path lockstep governs charges, not
// projections). The caption states the assumptions inline.
...
export function GymRevenueCalculator() {
  ...
  const monthlyRupees = Math.round(members * C.adoptionRate * C.standardPlanRupees * (tier / 100));
      ...
      <div className="mt-6 rounded-2xl border border-line bg-surface p-6">
        ...
        <div className="mt-6 grid items-center gap-4 border-t border-line pt-6 sm:grid-cols-2">
          <div>
            ...
            <p className="tabular mt-1 text-3xl font-bold text-ink sm:text-4xl">{formatPaise(monthlyRupees * 100)}</p>
          </div>
