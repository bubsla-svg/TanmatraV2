...
export function DrawerContent({
  ...
  return (
    <DrawerPortal>
      ...
      <VaulDrawer.Content
        {...props}
        className="fixed inset-x-0 bottom-0 z-[var(--z-modal)] mx-auto flex max-h-[92dvh] w-full max-w-2xl flex-col rounded-t-2xl border border-line bg-surface shadow-[var(--shadow-card)] outline-none"
      >
