    ...
    <div className="space-y-8" data-precision-draft-id={draftId}>
      ...
      <div className="bg-gradient-to-r from-emerald-600 to-teal-700 text-white p-6 sm:p-8 rounded-3xl shadow-xl flex flex-col sm:flex-row items-center justify-between gap-6">
        ...
        <button
          ...
          className="px-6 py-3 rounded-2xl bg-white text-emerald-950 font-black text-xs uppercase tracking-wider shadow-lg hover:bg-emerald-50 transition-all shrink-0 flex items-center gap-2 disabled:opacity-60"
        >
