  ...
  if (qty === 0) {
    return (
      <button
        ...
        className="min-h-11 rounded-full bg-yellow-500 px-6 py-2 text-sm font-bold tracking-tight text-neutral-900 hover:bg-yellow-500/90 transition-transform active:scale-[0.98]"
      >
        Add to Order
      </button>
    );
