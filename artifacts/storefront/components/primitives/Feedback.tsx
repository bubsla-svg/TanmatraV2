...
export const InlineError: React.FC<InlineErrorProps> = ({ message, className = "" }) => {
  ...
  return (
    <div className={`flex items-start gap-2 text-red-400 bg-red-400/10 p-3 rounded-lg border border-red-400/20 ${className}`}>
...
export const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  return (
    <div className={`flex flex-col items-center justify-center text-center p-8 max-w-md mx-auto ${className}`}>
      {imageUrl && (
        <div className="w-48 h-48 mb-6 rounded-full overflow-hidden bg-neutral-900 border border-white/5 relative">
