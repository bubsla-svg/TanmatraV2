...
export const TextInput: React.FC<TextInputProps> = ({ label, error, className = "", ...props }) => {
  return (
    <div className="flex flex-col gap-1.5 w-full">
      ...
      <input
        className={`w-full bg-surface border border-white/5 rounded-xl px-4 py-3 text-ink placeholder:text-ink-muted focus:outline-none focus:ring-2 focus:ring-gold focus:border-transparent transition-all ${
  ...
  return (
    <div className="flex flex-col gap-1.5 w-full">
      ...
      <div className="relative">
        ...
        <input
          className={`w-full bg-surface border border-white/5 rounded-full pl-11 pr-4 py-3 text-ink placeholder:text-ink-muted focus:outline-none focus:ring-2 focus:ring-gold focus:border-transparent transition-all ${
