      ...
      <div className="fixed inset-x-0 bottom-0 z-30 border-t border-line bg-[var(--glass)] pb-[env(safe-area-inset-bottom)] backdrop-blur-md">
        <div className="mx-auto max-w-md px-4 py-3">
          ...
          <div className="mt-2 flex items-center justify-center gap-1.5 text-xs font-medium text-ink-muted">
            ...
            {/* Kitchen-level claims only (FSSAI licence, RD-reviewed kitchen) —
                the same house copy AlacarteDetails vouches its pay bar with.
                Per-dish "RD verified" badges stay removed (finding F5): the
                kitchen claim is backed by the licence; the per-dish one is not. */}
            Secure, encrypted checkout · FSSAI-licensed, RD-reviewed kitchen
          </div>
        </div>
      </div>
    </div>
