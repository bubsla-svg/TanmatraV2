  ...
  if (action.kind === "book_rd") {
    ...
    return (
      <div className="mt-2 flex flex-col gap-4 rounded-xl border border-line bg-surface p-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Link
          href={action.href}
          className="inline-flex shrink-0 items-center justify-center gap-1 self-start rounded-full bg-gold px-4 py-2 text-xs font-semibold text-[var(--gold-ink)] sm:self-center"
        >
