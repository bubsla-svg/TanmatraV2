...
export const DIFFERENTIATORS: LandingBenefit[] = [
  {
    ...
    body: "Every employee gets their own allergen- and preference-gated menu, with a published nutrition label on each dish — designed by registered dietitians and cooked in an ISO 22000:2018 kitchen (FSSAI Lic. 22725926001018).",
  },
  {
    icon: "clipboard",
