...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = condition.replace(/-/g, " ").toUpperCase();
  return { title: `${title} Therapeutic Care Plan | Tanmatra` };
}
  ...
  return (
    <div className="min-h-dvh pb-24">
      <section className="mx-auto max-w-xl px-4 py-12">
        ...
        <h1 className="mt-4 text-3xl font-semibold capitalize tracking-tight text-ink">
          {name} Protocol
        </h1>
