        ...
        <div className="bg-[#FBFAF7] text-[#1A1C1E] min-h-screen pb-32">
            ...
            <header className="w-full sticky top-0 bg-[#FBFAF7] z-40 border-b border-[#E7E3DA] px-4 h-16 flex items-center justify-between max-w-[1200px] mx-auto">
                <Link href="/" className="font-headline-md text-lg font-bold text-[#D4AF37] tracking-wider">
                    TANMATRA <span className="text-[#1A1C1E] text-xs font-normal ml-1 font-label-caps">CLUBS</span>
                </Link>
                <a href="#club-form" className="text-xs font-bold bg-[#D4AF37] text-[#1A1C1E] px-4 py-2 rounded-full hover:opacity-90 transition-opacity">
                    Join Network
                </a>
            </header>
            ...
            <section className="relative w-full min-h-[500px] flex items-center justify-center overflow-hidden border-b border-[#E7E3DA] px-4 py-16">
                <div className="max-w-[800px] mx-auto text-center space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                        <a href="#club-form" className="w-full sm:w-auto bg-[#D4AF37] text-[#1A1C1E] font-label-caps text-xs font-bold px-8 py-4 rounded-full hover:opacity-90 active:scale-[0.98] transition-all shadow-sm">
                            Apply for Club Partnership
                        </a>
                        <Link href="/challenges" className="w-full sm:w-auto bg-white border border-[#E7E3DA] text-[#1A1C1E] font-label-caps text-xs font-bold px-8 py-4 rounded-full hover:bg-black/5 active:scale-[0.98] transition-all">
            ...
            <main className="max-w-[1200px] mx-auto px-4 mt-16 space-y-16">
                ...
                <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white border border-[#E7E3DA] rounded-2xl p-6 shadow-sm space-y-3">
                        ...
                        <h3 className="font-headline-md text-base font-bold text-[#1A1C1E]">Race-Day Carb &amp; Glycogen Loading</h3>
                    ...
                    <div className="bg-white border border-[#E7E3DA] rounded-2xl p-6 shadow-sm space-y-3">
                        ...
                        <h3 className="font-headline-md text-base font-bold text-[#1A1C1E]">Custom Club Challenges</h3>
                        <p className="font-body-sm text-xs text-[#5C6367] leading-relaxed">
                    ...
                    <div className="bg-white border border-[#E7E3DA] rounded-2xl p-6 shadow-sm space-y-3">
                        ...
                        <h3 className="font-headline-md text-base font-bold text-[#1A1C1E]">20% Club Token Discount</h3>
                        <p className="font-body-sm text-xs text-[#5C6367] leading-relaxed">
                ...
                {/* Application Form */}
                <section id="club-form" className="bg-white border border-[#E7E3DA] rounded-2xl p-8 shadow-sm max-w-2xl mx-auto space-y-6">
                    <div className="text-center space-y-2">
                        <span className="font-label-caps text-xs text-[#D4AF37] uppercase tracking-widest font-bold">CLUB REGISTRATION</span>
                        <h2 className="font-headline-md text-2xl font-bold text-[#1A1C1E]">Partner Your Fitness Club</h2>
                    ...
                    {submitted ? (
                        <div className="bg-[#EBF2EB] border border-[#7D9E7E]/30 rounded-2xl p-6 text-center space-y-2">
                            ...
                            <h3 className="font-headline-md text-base font-bold text-[#1A1C1E]">Club Partnership Registered</h3>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="space-y-1">
                                    <label className="font-body-sm text-xs text-[#5C6367] block">Club Name</label>
                                    <input 
                                        type="text"
                                        value={clubName}
                                ...
                                <div className="space-y-1">
                                    <label className="font-body-sm text-xs text-[#5C6367] block">Club Lead Email</label>
                                    <input 
                                        type="email"
                                        value={email}
                            ...
                            <div className="space-y-1">
                                <label className="font-body-sm text-xs text-[#5C6367] block">Club Discipline</label>
                                <select 
                                    value={discipline}
