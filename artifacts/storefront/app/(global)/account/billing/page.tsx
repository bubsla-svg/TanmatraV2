...
export default function BillingPage() {
  return (
    <section className="mx-auto max-w-md px-4 py-10">
      ...
      <h1 className="font-display text-3xl font-semibold leading-[1.05] tracking-[-.02em] text-primary">Billing &amp; credits</h1>
      <p className="mt-2 mb-6 text-sm text-ink-muted">Your wallet balance and credit activity.</p>
      <BillingPanel />
    </section>
  );
}
