        ...
        <div className="bg-[#FBFAF7] text-[#1A1C1E] min-h-screen pb-32">
            ...
            <header className="w-full sticky top-0 bg-[#FBFAF7] z-40 border-b border-[#E7E3DA] px-4 h-16 flex items-center justify-between max-w-[1200px] mx-auto">
                <Link href="/" className="font-headline-md text-lg font-bold text-[#D4AF37] tracking-wider">
                    TANMATRA <span className="text-[#1A1C1E] text-xs font-normal ml-1 font-label-caps">ENTERPRISE</span>
                </Link>
                <div className="flex items-center gap-3">
                    <a href="#redeem" className="text-xs font-semibold text-[#5C6367] hover:text-[#1A1C1E]">
                        Redeem Token
                    </a>
                    <a href="#pilot" className="text-xs font-bold bg-[#D4AF37] text-[#1A1C1E] px-4 py-2 rounded-full hover:opacity-90 transition-opacity">
                        Request Pilot
                    </a>
                </div>
            </header>
            ...
            <section className="relative w-full min-h-[520px] flex items-center justify-center overflow-hidden border-b border-[#E7E3DA] px-4 py-16">
                <div className="max-w-[800px] mx-auto text-center space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                        <a href="#pilot" className="w-full sm:w-auto bg-[#D4AF37] text-[#1A1C1E] font-label-caps text-xs font-bold px-8 py-4 rounded-full hover:opacity-90 active:scale-[0.98] transition-all shadow-sm">
                            Launch Team Pilot (Free 14-Day Trial)
                        </a>
                        <a href="#redeem" className="w-full sm:w-auto bg-white border border-[#E7E3DA] text-[#1A1C1E] font-label-caps text-xs font-bold px-8 py-4 rounded-full hover:bg-black/5 active:scale-[0.98] transition-all">
            ...
            <main className="max-w-[1200px] mx-auto px-4 mt-16 space-y-16">
                ...
                <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white border border-[#E7E3DA] rounded-2xl p-6 shadow-sm space-y-3">
                        ...
                        <h3 className="font-headline-md text-base font-bold text-[#1A1C1E]">Flexible Employer Subsidies</h3>
                    ...
                    <div className="bg-white border border-[#E7E3DA] rounded-2xl p-6 shadow-sm space-y-3">
                        ...
                        <h3 className="font-headline-md text-base font-bold text-[#1A1C1E]">Zero-Seed-Oil Clinical Kitchens</h3>
                        <p className="font-body-sm text-xs text-[#5C6367] leading-relaxed">
                    ...
                    <div className="bg-white border border-[#E7E3DA] rounded-2xl p-6 shadow-sm space-y-3">
                        ...
                        <h3 className="font-headline-md text-base font-bold text-[#1A1C1E]">RD-Led Metabolic Advisory</h3>
                        <p className="font-body-sm text-xs text-[#5C6367] leading-relaxed">
                ...
                <section id="redeem" className="bg-white border border-[#E7E3DA] rounded-2xl p-8 shadow-sm max-w-xl mx-auto space-y-4 text-center">
                    <span className="font-label-caps text-xs text-[#D4AF37] uppercase tracking-widest font-bold">EMPLOYEE ONBOARDING</span>
                    <h2 className="font-headline-md text-2xl font-bold text-[#1A1C1E]">Redeem Company Access Token</h2>
                    <p className="font-body-sm text-xs text-[#5C6367]">
                        Enter your corporate authorization code (e.g. <code className="bg-[#FBFAF7] px-1.5 py-0.5 rounded text-[#1A1C1E]">token_corp_google</code>) to unlock your subsidized plan.
                    </p>
                    ...
                    <form onSubmit={handleRedeemToken} className="flex gap-2 pt-2">
                        <input 
                            ...
                            className="flex-grow px-4 py-3 rounded-xl border border-[#E7E3DA] text-sm bg-[#FBFAF7] focus:outline-none focus:border-[#D4AF37]"
                            required
                        />
                        <button type="submit" className="bg-[#D4AF37] text-[#1A1C1E] font-label-caps text-xs font-bold px-6 py-3 rounded-xl hover:opacity-90 transition-opacity">
                            Verify
                        </button>
                    </form>
                </section>
                ...
                <section id="pilot" className="bg-white border border-[#E7E3DA] rounded-2xl p-8 shadow-sm max-w-2xl mx-auto space-y-6">
                    <div className="text-center space-y-2">
                        <span className="font-label-caps text-xs text-[#D4AF37] uppercase tracking-widest font-bold">GET STARTED</span>
                        <h2 className="font-headline-md text-2xl font-bold text-[#1A1C1E]">Request an Enterprise Tasting &amp; Pilot</h2>
                        <p className="font-body-sm text-xs text-[#5C6367]">
                    ...
                    {submittedDemo ? (
                        <div className="bg-[#EBF2EB] border border-[#7D9E7E]/30 rounded-2xl p-6 text-center space-y-2">
                            ...
                            <h3 className="font-headline-md text-base font-bold text-[#1A1C1E]">Pilot Request Received</h3>
                        ...
                        <form onSubmit={handleDemoSubmit} className="space-y-4">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="space-y-1">
                                    <label className="font-body-sm text-xs text-[#5C6367] block">Company Name</label>
                                    <input 
                                        type="text"
                                        value={companyName}
                            ...
                            <div className="space-y-1">
                                <label className="font-body-sm text-xs text-[#5C6367] block">Team Size</label>
                                <select 
                                    value={teamSize}
