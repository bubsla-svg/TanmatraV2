...
export function sendError(
  ...
  // Optional chaining: bare test-harness apps built around a router in
  // isolation (this repo's dominant test pattern) don't always attach the
  // pino-http middleware that populates req.log.
