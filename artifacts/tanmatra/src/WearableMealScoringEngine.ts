...
export class WearableMealScoringEngine {
  ...
  public static translateTelemetry(
    ...
    if (
      ...
      telemetry.hrv_status === 'high_strain'
    ) {
      return {
        protocol: 'Wellness',
        ...
        clinical_reasoning:
          'Biometric strain detected: Sleep efficiency < 75% or high HRV strain. Activating Wellness Protocol to select light, easily digestible, and balanced meals.',
      };
    }
