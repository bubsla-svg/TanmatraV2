          ...
          <div className="px-4 h-12 rounded-full bg-white/[0.03] border border-white/5 flex items-center justify-between gap-4 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
            ...
            <div className="flex items-center gap-1.5 pr-1">
              ...
              <button
                ...
                className="hidden md:inline-flex items-center gap-2 h-8 px-3 rounded-full border border-white/10 bg-white/5 text-xs text-white/70 hover:text-white hover:border-white/20 transition-all touch-target-48"
              >
              ...
              <button
                ...
                onClick={() => palette.setOpen(true)}
                aria-label="Open command palette"
                className="md:hidden inline-flex items-center justify-center h-8 w-8 rounded-full text-white/70 hover:text-white hover:bg-white/10 transition-colors touch-target-48"
              >
              ...
              <button
                ...
                className="relative inline-flex items-center justify-center h-8 sm:px-3 rounded-full bg-white/5 border border-white/10 text-white/90 hover:bg-white/10 transition-colors touch-target-48"
              >
