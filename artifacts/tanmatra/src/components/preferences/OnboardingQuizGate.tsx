  ...
  return (
    <>
      {bannerVisible && (
        ...
        >
          <div className={`max-w-2xl mx-auto ${scrollHidden ? "pointer-events-none" : "pointer-events-auto"} bg-nn-surface border border-nn-primary/30 shadow-clinical-lg rounded-xl px-4 py-3 flex items-center gap-3`}>
            <div className="w-8 h-8 rounded-lg bg-nn-primary/15 border border-nn-primary/30 flex items-center justify-center shrink-0">
              <Sparkles className="w-4 h-4 text-nn-primary" />
            </div>
            ...
            <button
              ...
              className="shrink-0 min-h-11 text-[11px] font-bold uppercase tracking-wider px-4 py-2 rounded-md bg-nn-primary text-action-text hover:bg-nn-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-nn-primary focus-visible:ring-offset-2 focus-visible:ring-offset-nn-surface"
            >
              Start
            </button>
            <button
              ...
              className="shrink-0 w-11 h-11 rounded-md text-nn-on-surface-variant hover:text-white hover:bg-white/5 flex items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-nn-primary focus-visible:ring-offset-2 focus-visible:ring-offset-nn-surface"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
