    ...
    <div className="nn-clinical bg-nn-bg text-white min-h-screen pb-16">
      ...
      <div className="sticky top-0 z-40 bg-nn-bg/95 backdrop-blur-md border-b border-white/[0.08] px-4 py-3">
        <div className="max-w-5xl mx-auto flex items-center justify-between gap-3">
          <div className="flex items-center gap-2.5 bg-nn-surface border border-white/[0.064] rounded-full px-3.5 py-1.5 cursor-pointer hover:border-nn-primary/50 transition-colors max-w-sm sm:max-w-md min-w-0">
          ...
          <Link to="/subscribe?trial=1">
            <Button size="sm" className="bg-nn-primary text-stone-900 hover:bg-nn-primary/90 text-xs font-semibold h-8 px-3.5 rounded-full">
              3-Day Trial
            </Button>
          </Link>
        </div>
      ...
      <section className="py-12 md:py-16 px-4 text-center space-y-4 max-w-4xl mx-auto">
        ...
        <h1 className="text-clinical-h1 md:text-[clamp(2.25rem,1.4rem+2.6vw,3.25rem)] md:leading-[1.06] tracking-tight text-white font-extrabold">
          ...
          <span
            ...
            style={{ backgroundImage: "linear-gradient(to right, #" + "E7C766, var(--color-nn-primary))" }}
          >
            delivered daily.
          </span>
        </h1>
        <p className="text-sm sm:text-base text-nn-on-surface-variant max-w-lg mx-auto leading-relaxed">
      ...
      <section className="max-w-5xl mx-auto px-4 pb-12">
        <p className="text-xs uppercase tracking-[0.2em] font-extrabold text-nn-primary mb-4 text-left">
          PLAN BENEFITS
        </p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card
            className="border-white/[0.08] overflow-hidden relative group hover:border-nn-primary/40 transition-all"
            style={{ background: "linear-gradient(to bottom right, var(--color-nn-surface), var(--color-nn-surface) 50%, #" + "0a151b)" }}
          >
            <CardContent className="p-5 flex flex-col justify-between h-48 sm:h-52">
              <div>
                ...
                <p className="text-xs text-nn-on-surface-variant mt-1.5">Swap any dish in your schedule or pause deliveries with 1-click.</p>
              </div>
              <div className="flex items-center gap-2 mt-4 pt-3 border-t border-white/[0.04] text-xs text-nn-primary font-semibold">
          ...
          <Card
            className="border-white/[0.08] overflow-hidden relative group hover:border-nn-primary/40 transition-all"
            style={{ background: "linear-gradient(to bottom right, var(--color-nn-surface), var(--color-nn-surface) 50%, #" + "0d1a12)" }}
          >
            <CardContent className="p-5 flex flex-col justify-between h-48 sm:h-52">
              <div>
                <h3 className="text-lg font-extrabold text-white leading-snug">High protein clinical meals</h3>
                <p className="text-xs text-nn-on-surface-variant mt-1.5">Every meal signed off by clinical RDs to hit your exact macro goals.</p>
              </div>
              <div className="flex items-center gap-2 mt-4 pt-3 border-t border-white/[0.04] text-xs text-clinical-sage font-semibold">
          ...
          <Card
            className="border-white/[0.08] overflow-hidden relative group hover:border-nn-primary/40 transition-all"
            style={{ background: "linear-gradient(to bottom right, var(--color-nn-surface), var(--color-nn-surface) 50%, #" + "1a160b)" }}
          >
            <CardContent className="p-5 flex flex-col justify-between h-48 sm:h-52">
              <div>
                <h3 className="text-lg font-extrabold text-white leading-snug">From top kitchens & RD partners</h3>
                <p className="text-xs text-nn-on-surface-variant mt-1.5">Prepared fresh daily in temperature-controlled specialty kitchens.</p>
              </div>
              <div className="flex items-center gap-2 mt-4 pt-3 border-t border-white/[0.04] text-xs text-nn-primary font-semibold">
      ...
      <section className="max-w-5xl mx-auto px-4 pb-12">
        <Card className="relative overflow-hidden border-nn-primary/40 bg-gradient-to-br from-nn-primary/12 via-nn-primary/5 to-transparent rounded-2xl shadow-xl">
          <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-nn-primary/50 to-transparent" />
          <CardContent className="p-6 md:p-8 flex flex-col md:flex-row md:items-center gap-6">
            <div className="flex-1 space-y-3">
              <Badge className="bg-nn-primary text-stone-900 text-[10px] uppercase font-bold tracking-widest px-2.5 py-0.5">
                Start here
              </Badge>
            ...
            <div className="shrink-0 md:text-right space-y-3">
              ...
              <Link to="/subscribe?trial=1" className="block">
                <Button className="w-full md:w-auto bg-nn-primary text-stone-900 hover:bg-nn-primary/90 font-semibold gap-2 h-11 px-6 rounded-xl">
      ...
      <section id="all-kitchens" className="max-w-5xl mx-auto px-4 pt-4 space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <div className="relative">
              <select
                ...
                className="appearance-none bg-nn-surface border border-white/[0.08] hover:border-nn-primary/40 text-xs font-semibold text-white rounded-xl pl-3 pr-8 py-2 focus:outline-none focus:ring-1 focus:ring-nn-primary cursor-pointer"
              >
              ...
              <SlidersHorizontal className="w-3.5 h-3.5 text-nn-on-surface-variant absolute right-2.5 top-1/2 -translate-y-1/2 pointer-events-none" />
            </div>
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none bg-nn-surface border border-white/[0.08] hover:border-nn-primary/40 text-xs font-semibold text-white rounded-xl pl-3 pr-8 py-2 focus:outline-none focus:ring-1 focus:ring-nn-primary cursor-pointer capitalize"
              >
                <option value="all">Mealtime: All Meals</option>
                <option value="lunch_dinner">Lunch & Dinner</option>
                <option value="dinner">Dinner Only</option>
              </select>
              <ChevronDown className="w-3.5 h-3.5 text-nn-on-surface-variant absolute right-2.5 top-1/2 -translate-y-1/2 pointer-events-none" />
            </div>
            ...
            <button
              ...
              className={`flex items-center gap-2 px-3.5 py-2 rounded-xl border text-xs font-semibold transition-all cursor-pointer ${
                vegOnly
                  ...
                  : "bg-nn-surface border-white/[0.08] text-white hover:border-nn-primary/40"
              }`}
            >
        ...
        <p className="text-xs uppercase tracking-[0.16em] font-bold text-nn-on-surface-variant">
        ...
        <div className="space-y-6">
          {PLANS.map((p) => {
            ...
            return (
              <Card
                key={p.id}
                className="bg-nn-surface border-white/[0.08] rounded-2xl overflow-hidden hover:border-nn-primary/40 transition-all shadow-md"
              >
                <CardContent className="p-6 space-y-5">
                  <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                    <div className="space-y-1.5">
                      <div className="flex items-center gap-2.5">
                        ...
                        {p.popular && (
                          <Badge className="bg-nn-primary text-stone-900 text-[9px] font-bold uppercase tracking-wider px-2 py-0.5">
                            Most Popular
                          </Badge>
                        )}
                      </div>
                      <div className="flex items-center gap-3 text-xs text-nn-on-surface-variant">
                        <span className="flex items-center gap-1 text-white font-medium">
                          <Icon className="w-3.5 h-3.5 text-nn-primary" /> Tanmatra Central Kitchen
                        </span>
                        <span>•</span>
                  ...
                  <p className="text-xs text-nn-on-surface-variant leading-relaxed max-w-2xl">{p.desc}</p>
                  ...
                  <div className="space-y-2 pt-1">
                    ...
                    <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-none">
                      {planDishes.map((dish) => (
                        <div key={dish.slug} className="shrink-0 w-44 sm:w-52 rounded-xl bg-nn-bg border border-white/[0.064] overflow-hidden flex flex-col justify-between group">
                          <div className="h-28 bg-nn-surface-high relative overflow-hidden flex items-center justify-center">
                            {dish.image ? (
                              ...
                              <Flame className="w-8 h-8 text-nn-primary/30 group-hover:scale-110 transition-transform" />
                            )}
                          ...
                          <div className="p-2.5 space-y-1">
                            ...
                            <p className="text-[10px] text-nn-on-surface-variant font-mono">{Math.round(dish.macros.calories)}kcal • {Math.round(dish.macros.protein)}g protein</p>
                          </div>
                        </div>
                      ))}
                    </div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-3 border-t border-white/[0.048]">
                    <div>
                    ...
                    <Link to={`/subscribe?protocol=${p.protocol}&cadence=${cadence}`} className="shrink-0">
                      <Button className="w-full sm:w-auto bg-nn-primary text-stone-900 hover:bg-nn-primary/90 font-bold text-xs h-10 px-6 rounded-xl shadow-md">
                        View plans
                      </Button>
                    </Link>
                  </div>
            ...
            return (
              ...
              >
                <CardContent className="p-6 space-y-5">
                  <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                    <div className="space-y-1.5">
                      <div className="flex items-center gap-2.5 flex-wrap">
                        <h3 className="text-xl font-extrabold text-white tracking-tight">{p.name}</h3>
                        <Badge className="bg-nn-primary/15 text-nn-primary border-nn-primary/30 text-[9px] font-bold uppercase tracking-wider px-2 py-0.5">
                          RD Clinical Plan
                        </Badge>
                      </div>
                      <div className="flex items-center gap-3 text-xs text-nn-on-surface-variant">
                        <span className="flex items-center gap-1 text-white font-medium">
                          <Stethoscope className="w-3.5 h-3.5 text-nn-primary" /> {p.rdAuthorSlug.replace("rd-", "").replace("-", " ").toUpperCase()}
                        </span>
                        <span>•</span>
                        <span>☀ Lunch | ☾ Dinner</span>
                      </div>
                  ...
                  <p className="text-xs text-nn-on-surface-variant leading-relaxed max-w-2xl">{p.description || p.tagline}</p>
      ...
      {/* How it works */}
      <section className="border-t border-white/[0.08] py-14 px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="text-center space-y-2">
                <div className="w-10 h-10 rounded-lg bg-nn-primary/10 border border-nn-primary/25 flex items-center justify-center mx-auto">
                  <s.icon className="w-5 h-5 text-nn-primary" />
                </div>
                <p className="text-sm font-semibold text-white">{s.title}</p>
                <p className="text-xs text-nn-on-surface-variant leading-relaxed">{s.body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="border-t border-white/[0.08] py-12 px-4">
        <div className="max-w-3xl mx-auto">
          <Card className="bg-nn-surface/40 border-white/[0.08]">
            <CardContent className="p-5 flex flex-col sm:flex-row sm:items-center gap-4">
              <div className="w-10 h-10 rounded-lg bg-nn-tertiary/10 border border-nn-tertiary/25 flex items-center justify-center shrink-0">
                <Stethoscope className="w-5 h-5 text-nn-tertiary" />
              </div>
              ...
              <Link to="/clinical" className="shrink-0">
                <Button
                  variant="outline"
                  className="bg-transparent border-nn-tertiary/40 text-nn-tertiary hover:bg-nn-tertiary/10 hover:text-nn-tertiary text-xs h-9 gap-1.5"
                >
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={i}
                className="rounded-lg border border-white/[0.08] bg-nn-surface p-4"
              >
          ...
          <div className="flex items-center justify-center gap-2 pt-2 text-[11px] text-nn-on-surface-variant">
            <Pause className="w-3.5 h-3.5 text-nn-primary" />
            Pause anytime · <RefreshCw className="w-3.5 h-3.5 text-nn-primary" /> Cancel
            anytime · no lock-in
          </div>
        </div>
      </section>
