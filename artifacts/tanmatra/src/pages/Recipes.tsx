...
export const meta: MetaFunction = () => [
  ...
  { property: "og:url", content: "https://tanmatra.food/recipes" },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:title", content: "Healthy Recipes | Tanmatra" },
  { name: "twitter:description", content: "Dietitian-curated recipes with balanced macros. Filter by goal, diet, and prep time." },
  { name: "twitter:image", content: "https://tanmatra.food/opengraph.jpg" },
  { tagName: "link", rel: "canonical", href: "https://tanmatra.food/recipes" },
];
